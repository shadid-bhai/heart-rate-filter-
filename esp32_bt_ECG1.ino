...
<body>
  ...
  <div class="panel">
    <div class="row">
      ...
      <input type="number" id="patientAge" placeholder="Patient Age" min="0" max="150">
    </div>

    <div class="row">
      <button id="startBtn" onclick="startRecording()">Start Recording</button>
      <button id="stopBtn" class="danger" onclick="stopRecording()" disabled>Stop Recording</button>
      <button id="downloadBtn" class="success" onclick="downloadExcel()" disabled>Download Excel</button>
    </div>

    <div class="status" id="recordStatus"><span class="warn">Enter patient details, then start.</span></div>
